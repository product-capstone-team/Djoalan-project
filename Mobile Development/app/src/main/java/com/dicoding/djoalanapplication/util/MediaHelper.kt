...
object MediaHelper {
    ...
    fun createTempFile(context: Context): File {
        ...
        val timesStamp: String = SimpleDateFormat(FILENAME_FORMAT, Locale.US).format(System.currentTimeMillis())

        val storageDirectory: File? = context.getExternalFilesDir(Environment.DIRECTORY_PICTURES)
        return File.createTempFile(timesStamp, ".jpg", storageDirectory)
    }
